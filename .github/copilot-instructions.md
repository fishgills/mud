...
- **Backend**: NestJS services communicating via REST
...
- Add REST decorators for schema generation
...
- Return REST errors with proper error codes
...
- Use REST for service-to-service calls
...
3. **Type Safety**: Avoid usage of `any`
