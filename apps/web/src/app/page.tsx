    ...
    <div className="layout">
      ...
      >
        ...
        <div className="dialog-box">
          <p>
            Welcome, adventurer! BattleForge runs entirely in Slack. Send
            commands like <span style={{ color: 'var(--gold)' }}>raid</span>,{' '}
            <span style={{ color: 'var(--gold)' }}>attack</span>, and{' '}
            <span style={{ color: 'var(--gold)' }}>stats</span> to begin your
            quest.
          </p>
        ...
        >
          <a
            ...
            href="https://slack.battleforge.app/slack/install"
          ...
          {!session && (
            <a className="btn" href="/api/auth/slack/start">
              SIGN IN
            </a>
          )}
        </div>
